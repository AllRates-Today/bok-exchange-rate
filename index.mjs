// Bank of Korea exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bok';
...
/** Latest rate for one pair, e.g. getRate('USD', 'KRW', { apiKey }). */
