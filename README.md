...
Official **Bank of Korea** (South Korea) daily exchange rates in Node.js / TypeScript — ~40 currencies against the KRW, with history back to 1964. Zero dependencies, works in Node 18+, Bun, Deno, and edge runtimes (uses global `fetch`).
...
Powered by [AllRatesToday](https://allratestoday.com/central-bank-rates-api/bok/). Get a free API key at [allratestoday.com/register](https://allratestoday.com/register) — 300 requests/month, no credit card.
